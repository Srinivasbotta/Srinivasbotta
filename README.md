...
<head>
    ...
    <!-- Google Fonts & Font Awesome for crisp icons and readability -->
    ...
    <style>
        * {
        ...
        /* Main card — glassmorphic + refined shadow */
        .portfolio-card {
            max-width: 1380px;
            width: 100%;
        ...
        /* header section with status ribbon */
        .header-row {
            display: flex;
            flex-wrap: wrap;
        ...
        /* skill proficiency bars (modern interpretation) */
        .skills-grid {
            display: grid;
        ...
        /* tech stack cards with icons glow */
        .tech-stack-section {
        ...
        /* featured projects & learning roadmap dual layout */
        .projects-roadmap {
            display: grid;
        ...
        .completed { color: #2b7a4b; }
        .progress { color: #e6a017; }
        ...
        .connect-links a:hover { color: #0f5b86; transform: scale(1.05);}
        
        /* quote + fun ascii/code loop */
        .footer-quote {
            margin-top: 1.8rem;
            background: #0a1927;
            color: #bfd9e8;
        ...
        @media (max-width: 780px) {
            ...
            .projects-roadmap { grid-template-columns: 1fr; gap: 1.2rem; }
            .stats-ribbon { gap: 1rem; justify-content: center; }
        }
        .glow-text {
...
<div class="portfolio-card">
    <div class="container">
        ...
        <!-- numeric stats badges (12+ projects etc) dynamic yet precise -->
        ...
        <!-- SKILL PROFICIENCY section with dynamic bars -->
        ...
        <!-- TECH STACK: vibrant rows with icons -->
        ...
        <!-- CURRENTLY LEARNING + PROJECTS + ROADMAP -->
        <div style="margin: 1rem 0 0.5rem">
            <div class="section-badge"><i class="fas fa-graduation-cap"></i> CURRENTLY LEARNING <span style="background:#ffe8cf; font-size:0.7rem; padding:2px 12px; border-radius:40px; margin-left:12px;"><i class="fas fa-microphone-alt"></i> LLMs & Prompt Engineering · RAG Pipelines</span></div>
        </div>
        ...
        <div class="projects-roadmap">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card"><div class="project-info"><h4><i class="fas fa-comment-dots"></i> NLP Sentiment Engine</h4><span>Customer review sentiment REST API</span></div><div class="project-stats"><i class="fas fa-cloud-upload-alt"></i> Deployed API</div></div>
            ...
            <div class="roadmap">
                ...
                <div class="roadmap-item"><div class="status-icon progress"><i class="fas fa-spinner fa-pulse"></i></div><div>LLMs & GenAI</div><span style="margin-left:auto; background:#f2e3c2; padding:2px 8px; border-radius:20px;">in progress</span></div>
        ...
        <div class="cert-connect">
            <div class="certs">
                ...
                <div class="cert-badge"><i class="fas fa-check-circle" style="color:#1f6e8c"></i> Machine Learning Specialization (Stanford/DeepLearning.AI)</div>
            ...
            <div class="connect-links">
                ...
                <a href="#" target="_blank"><i class="fas fa-robot"></i> Hugging Face</a>
                <div style="margin-top: 12px; font-size: 0.75rem; color:#366f8c"><i class="fab fa-github"></i> github.com/srinivasu-ai</div>
            </div>
        </div>

        <!-- dynamic quote + fun code loop (exactly like "while eat() sleep() code() repeat()") -->
        ...
        <!-- Additional micro stats: accuracy, FPS, etc... embedded already in projects but add footnote -->
        <div style="display: flex; justify-content: flex-end; margin-top: 1rem; gap: 1rem; font-size:0.7rem; color:#446688">
            <span><i class="fas fa-chart-line"></i> 95%+ accuracy</span> <span><i class="fas fa-tachometer-alt"></i> 30 FPS on CPU</span> <span><i class="fas fa-chart-line"></i> 15% MAPE</span> <span><i class="fas fa-database"></i> 1M+ interactions</span>
        </div>
    </div>
</div>
</body>
